...
% Tillader if-then statements med \ifthenelse{condition}{thenCode}{elseCode}
\usepackage{ifthen}
...
\fancyfoot[L]{\small\scshape
    \ifthenelse{\equal{\thepage}{1}}{
        ...
        \ifthenelse{\equal{\thepage}{2}}{
            Indholdsfortegnelse for dispositioner % Speciel "titel" i anden sidefod
        }{
            Spg. \nouppercase{\leftmark}
        }
    }
