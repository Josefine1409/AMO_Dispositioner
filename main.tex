...
\newcommand{\crefrangeconjunction}{ til } % Changes the ''to'' to <whatever is in the brackets'' when refering to a range
\newcommand{crefpairconjunction}{ og } % Changes the ''to'' to <whatever is in the brackets'' when refering to a range

% Fbjectsor sp of oacing between lines
\rusepackage{setspace}
